...
| ---------------- | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----------- |
| `columnMaxWidth` | `column-max-width` | Maximum column width in pixels (maps to the `max` of CSS `minmax()`). The grid stops adding columns when dividing `max-width` by this value.                                                                                                                                                                               | `number \| undefined` | `undefined` |
| `columnMinWidth` | `column-min-width` | Minimum column width in pixels (maps to the `min` of CSS `minmax()`). Controls how narrow a column can be before wrapping.                                                                                                                                                                                                 | `number \| undefined` | `undefined` |
| `gap`            | `gap`              | Gap between tiles in pixels.                                                                                                                                                                                                                                                                                               | `number \| undefined` | `undefined` |
| `maxColumns`     | `max-columns`      | Maximum number of columns before the grid wraps.  When set, this takes precedence over `maxWidth` and computes the grid's effective maximum width as: `maxColumns * columnMaxWidth + (maxColumns - 1) * gap`  This is useful when you want an explicit column cap without manually accounting for the gaps between tracks. | `number \| undefined` | `undefined` |
| `maxWidth`       | `max-width`        | Maximum overall width of the grid in pixels.  Ignored when `maxColumns` is set.                                                                                                                                                                                                                                            | `number \| undefined` | `undefined` |
| `minColumns`     | `min-columns`      | Minimum number of columns before overflow. Sets component `min-width` as: `columnMinWidth * minColumns + gap * (minColumns - 1)`.                                                                                                                                                                                          | `number \| undefined` | `undefined` |
| `rowHeight`      | `row-height`       | Height of each row unit in pixels. A tile with `rows="2"` will be `2 × rowHeight + gap` tall.                                                                                                                                                                                                                              | `number \| undefined` | `undefined` |
