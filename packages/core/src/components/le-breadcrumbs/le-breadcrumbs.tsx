...
export class LeBreadcrumbs {
  ...
  @Listen('slotchange')
  handleGeneralSlotChange(ev: Event) {
    // Only rebuild items if the slot changing is not the separator
  ...
  render() {
    ...
    return (
      <Host onKeyDown={this.handleKeyDown}>
        ...
        <span class="hidden-slot" aria-hidden="true" style={{ display: 'none' }}>
