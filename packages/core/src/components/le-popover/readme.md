...
| `autoWidth`           | `auto-width`             | Whether the popover should size automatically to its content rather than matching the trigger width | `boolean`                                          | `false`     |
...
| `dragThrough`         | `drag-through`           | Whether to enable press-drag-release selection                                                      | `boolean`                                          | `false`     |
| `matchTriggerWidth`   | `match-trigger-width`    | Whether the popover width should match the trigger width                                            | `boolean`                                          | `false`     |
