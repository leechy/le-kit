...
| `message`         | `message`           | Message text to display (for alert/confirm/prompt types)                                | `string \| undefined`                                                                           | `undefined` |
...
| `popupTitle`      | `popup-title`       | Optional title for the popup header                                                     | `string \| undefined`                                                                           | `undefined` |
