...
function generateMarkdown(components) {
  ...
  md += 'This file is auto-generated and contains documentation for all Le-Kit web components. It is intended to be used as context for AI coding assistants.\n\n';
  ...
  components.forEach(c => {
    ...
    // Props
    const props = (c.members || []).filter(m => m.kind === 'field' && !m.static && m.privacy !== 'private' && m.privacy !== 'protected');
    if (props.length > 0) {
      md += '### Properties\n\n';
